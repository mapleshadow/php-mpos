      ...
      <div class="col-lg-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h5><i class="fa fa-info-circle fa-fw"></i> 最新新闻</h5>
          </div>
...
{section name=news loop=$NEWS}
              <div class="panel panel-default">
                <div class="panel-heading">
                  ...
                  <br />
                  <font size="1px">发布于 {$NEWS[news].time|date_format:$GLOBAL.config.date}{if $HIDEAUTHOR|default:"0" == 0} by <b>{$NEWS[news].author}</b>{/if}</font>
                </div>
