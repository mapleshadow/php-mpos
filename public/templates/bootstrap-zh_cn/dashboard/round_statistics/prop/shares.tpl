      <table class="table borderless m-b-none text-small panel-footer">
        <thead>
          <tr>
            <th></th>
            <th><span><h5><i class="fa fa-user fa-fw"></i> 自己</h5></span></th>
            <th><span><h5><i class="fa fa-users fa-fw"></i> 矿池</h5></span></th>
          </tr>
          <tr>
            <th><h5><i class="fa fa-smile-o fa-fw"></i> 有效</h5></th>
            <th>
          ...
          <tr>
            <th><h5><i class="fa fa-frown-o fa-fw"></i> 无效</h5></th>
            <th>
            <div class="progress progress-striped progress-fix">
          ...
          <tr>
            <th><h5><i class="fa fa-bolt fa-fw"></i> 难度</h5></th>
            <th>
