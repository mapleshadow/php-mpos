  <div class="col-lg-6">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-tachometer fa-fw"></i> 算力排行
      </div>
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th class="text-right">{$GLOBAL.config.currency}/天</th>
              {if $GLOBAL.config.price.enabled}
              {if $GLOBAL.config.price.currency}<th class="text-right">{$GLOBAL.config.price.currency}/天</th>{/if}
               {/if}
            </tr>
          </thead>
          <tbody>
